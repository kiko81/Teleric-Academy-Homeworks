namespace MessageQueue
{
    ...
    public class ImageUploader
    {
        ...
        private const string DropboxAppKey = "izihiq3v75im5rz";
        private const string DropboxAppSecret = "t38t3cdkm84fl4d";
        ...
        static void Main()
        {
            ...
            // Upload files
            foreach (var file in Directory.EnumerateFiles("../../../Cat", "*.png"))
            {
                Entry uploadFileEntry = dropbox.UploadFileAsync(
                new FileResource(file),
                "/" + newFolderName + "/" + Guid.NewGuid() + ".png").Result;
