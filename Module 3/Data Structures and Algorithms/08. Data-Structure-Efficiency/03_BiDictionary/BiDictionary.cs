namespace BiDictionary
{
        ...
        where K2 : IComparable<K2>
    {
        ...
        {
            var isFoundKey1 = this.collectionOrderedByKey1.ContainsKey(key1);
            var isFoundKey2 = this.collectionOrderedByKey2.ContainsKey(key2);
        ...
        {
            return this.collectionOrderedByKey1.ContainsKey(key1) ? this.collectionOrderedByKey1[key1] : null;
        }

        public ICollection<T> Find(K2 key2)
        {
            return this.collectionOrderedByKey2.ContainsKey(key2) ? this.collectionOrderedByKey2[key2] : null;
        }
